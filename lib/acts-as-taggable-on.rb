...
WARNING
    ...
    def self.apply_binary_collation(bincoll)
      if Utils.using_mysql?
        ...
        begin
          ActiveRecord::Migration.execute("ALTER TABLE #{Tag.table_name} MODIFY name_es varchar(255) CHARACTER SET utf8 COLLATE #{coll};")
          ActiveRecord::Migration.execute("ALTER TABLE #{Tag.table_name} MODIFY name_eu varchar(255) CHARACTER SET utf8 COLLATE #{coll};")
          ActiveRecord::Migration.execute("ALTER TABLE #{Tag.table_name} MODIFY name_en varchar(255) CHARACTER SET utf8 COLLATE #{coll};")
        rescue Exception => e
